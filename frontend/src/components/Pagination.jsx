    ...
    return (
        <div className={`flex items-center justify-center gap-2 ${className}`}>
            <button
                ...
                className="px-3 py-1 rounded border border-gray-300 dark:border-gray-700 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-100 dark:hover:bg-gray-800"
            >
                Previous
            </button>
